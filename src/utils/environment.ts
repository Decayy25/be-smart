...
export const STORAGE_API_BASE_URL: string =
  process.env.STORAGE_API_BASE_URL || "http://localhost:3002";
export const STORAGE_API_SECRET: string =
  process.env.STORAGE_API_SECRET || "be-smart-secret";
